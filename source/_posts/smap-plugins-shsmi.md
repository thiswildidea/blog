...
```
[![区县数据](https://gitee.com/thiswildidea/images/raw/master/others/Datatable.png "Smap使用示例代码")](https://gitee.com/thiswildidea/images/blob/master/resouces/boundary/qx_boundary.xlsx)
[![街道数据](https://gitee.com/thiswildidea/images/raw/master/others/Datatable.png "Smap使用示例代码")](https://gitee.com/thiswildidea/images/blob/master/resouces/boundary/jwh_boundary.xlsx)
[![居委会数据](https://gitee.com/thiswildidea/images/raw/master/others/Datatable.png "Smap使用示例代码")](https://gitee.com/thiswildidea/images/blob/master/resouces/boundary/qx_boundary.xlsx)
### 区县街道居委会边界设置注意事项
```js
